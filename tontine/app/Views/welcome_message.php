    ...
    <h1>Gerer ma tontine </h1>
    <p class="fs-5 col-md-8">
		Facilement gerer sa tontine. Une interface conviviale, envoi de sms de rappel,
		suivi des cotisation, parametrage d'une tontine, attribution des droits,...
	</p>
