...
<?php  endif ?>
        ...
        <div class="col-sm-6">
            ...
            <?= form_input(['name'=>'label','class'=>'form-control','placeholder'=>'saisir le label','value'=>set_value("nom")]) ?>    
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-6">
            ...
            <input type="date" name="dateDeb" class="form-control" value="set_value('dateDeb')" >
        </div>
        <div class="col-sm-6">
