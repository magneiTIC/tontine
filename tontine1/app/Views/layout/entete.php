...
<?php if ( session()->get("profil")=="adherent" ):?>
  <ul class="nav nav-pills">
        <li class="nav-item"><a href="<?= base_url() ?>/adherent" class="nav-link <?= $menuActif=="adherentAcceuil"?"active":""?> ">Acceuil</a></li>
  ...
  <?php  elseif(session()->get('profil')=='administrateur') : ?>
    <ul class="nav nav-pills">
      ...
      <?php /* <li class="nav-item"><a href="<?= base_url() ?>/administrateur" class="nav-link <?= $menuActif=="administrateurAcceuil "?"active":""?> " aria-current="page">Acceuil</a></li> */ ?>
      
        <li class="nav-item"><a href="<?= base_url() ?>/administrateur" class="nav-link <?= $menuActif=="administrateurAcceuil"?"active":""?> ">Acceuil</a></li>
        <li class="nav-item"><a href="<?= base_url() ?>/administrateur/gestion" class="nav-link <?= $menuActif=="gestionUtilisateur"?"active":""?> ">Gestion des utilisateurs</a></li>
        <li class="nav-item"><a href="<?= base_url() ?>/utilisateur/deconnexion" class="nav-link">Deconnexion</a></li>
    </ul>
 
    <?php else:  ?>
      <ul class="nav nav-pills">
        <li class="nav-item"><a href="<?= base_url() ?>" class="nav-link <?= $menuActif=="acceuil"?"active":""?> " aria-current="page">Acceuil</a></li>
